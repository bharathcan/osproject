...
int i,j,k, smallest, count = 0, time, limit;

double wait_time = 0, turnaround_time = 0, end;

float average_waiting_time, average_turnaround_time; printf("\nEnter the Total Number of students:-"); scanf("%d", &limit);

printf("\n Enter id numbers of the student ");
 for(j=1;j<=limit;j++)
{

printf("\n Enter id number of %d student:-",j); scanf("%d",&k);
